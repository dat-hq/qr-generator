...
const TRANSLATIONS = {
  ...
  "vi-VN": {
    ...
    "urlPlaceholder": "vidu.com hoặc https://vidu.com",
    "urlHelp": "Nhập URL website. Nếu không có http://, chúng tôi sẽ tự động thêm https://",
    ...
    "emailAddress": "Email",
    "emailPlaceholder": "nguyen.vana@vidu.com",
    "organization": "Tổ chức",
    "organizationPlaceholder": "Tên công ty",
    "website": "Website",
    "websitePlaceholder": "https://vidu.com",
    "clearAllFields": "Xóa tất cả",
    "generatedQrCode": "Mã QR đã tạo",
    "scanQrCode": "Quét mã QR này bằng thiết bị của bạn",
    "fillFormPrompt": "Điền thông tin để tạo mã QR",
    "download": "Tải xuống",
    "copyData": "Sao chép",
    "copied": "Đã sao chép!",
    "qrCodeData": "Dữ liệu mã QR:",
    "footerText": "Tạo mã QR ngay lập tức • Không lưu dữ liệu • Miễn phí",
    "qrCodeAlt": "Mã QR đã tạo"
  }
};

// Tự động phát hiện ngôn ngữ trình duyệt
const locale = navigator.language.startsWith('vi') ? 'vi-VN' : 
...
const QRCodeGenerator = () => {
  ...
  // Load QRious script một lần duy nhất
  ...
  }, [loadQRiousScript, createQR, generateFallbackQR]);
  ...
  const generateVCard = useCallback((contact) => {
...
END:VCARD`;
  ...
  useEffect(() => {
    ...
    setQrData(data);
    generateQRCode(data);
  }, [activeTab, urlInput, textInput, contactInfo, formatUrl, generateVCard, generateQRCode]);
